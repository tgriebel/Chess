...
bool ChessEngine::PerformMoveAction( const pieceHandle_t pieceHdl, const int32_t targetX, const int32_t targetY )
{
...
pieceHandle_t ChessEngine::FindPiece( const teamCode_t team, const pieceType_t type, const int32_t instance )
{
...
void ChessEngine::EnterPieceInGame( Piece* piece, const int32_t x, const int32_t y )
{
...
pieceInfo_t ChessEngine::GetInfo( const int32_t x, const int32_t y ) const
{
	pieceInfo_t info;
...
bool ChessEngine::GetLocation( const pieceHandle_t pieceType, int32_t& x, int32_t& y ) const
{
	const Piece* piece = s.GetPiece( pieceType );
